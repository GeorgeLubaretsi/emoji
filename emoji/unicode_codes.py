...
__all__ = ['EMOJI_UNICODE', 'UNICODE_EMOJI', 'EMOJI_ALIAS_UNICODE', 'UNICODE_EMOJI_ALIAS', 'FLAG_UNICODE', 'UNICODE_FLAG']
...
FLAG_UNICODE = {
    ...
    u':Cocos  Islands:': u'\U0001F1E8\U0001F1E8',
    ...
    u':Hong Kong:': u'\U0001F1ED\U0001F1F0',
    ...
    u':Myanmar:': u'\U0001F1F2\U0001F1F2',
...
UNICODE_FLAG = {v: k for k, v in FLAG_UNICODE.items()}
